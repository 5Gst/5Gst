...
Java_ru_fivegst_speedtest_backend_IperfRunner_mkfifo(JNIEnv* env, jobject, jstring jPipePath)
{
...
extern "C" JNIEXPORT int JNICALL
Java_ru_fivegst_speedtest_backend_IperfRunner_waitForProcessNoDestroy(__unused JNIEnv* env, jobject, jlong pid)
{
    return waitid(P_PID, static_cast<id_t>(pid), nullptr, WEXITED | WNOWAIT) == -1 ? errno : 0; // NOLINT(hicpp-signed-bitwise)
}

extern "C" JNIEXPORT int JNICALL
Java_ru_fivegst_speedtest_backend_IperfRunner_waitForProcess(__unused JNIEnv* env, jobject, jlong pid)
{
    return waitpid(static_cast<pid_t>(pid), nullptr, 0) == -1 ? errno : 0;
}

extern "C" JNIEXPORT int JNICALL
Java_ru_fivegst_speedtest_backend_IperfRunner_sendSigInt(__unused JNIEnv* env, jobject, jlong pid)
{
    return kill(static_cast<pid_t>(pid), SIGINT) == -1 ? errno : 0;
}

extern "C" JNIEXPORT int JNICALL
Java_ru_fivegst_speedtest_backend_IperfRunner_sendSigKill(__unused JNIEnv* env, jobject, jlong pid)
{
...
extern "C" JNIEXPORT int JNICALL
Java_ru_fivegst_speedtest_backend_IperfRunner_start(
        JNIEnv* env,
        jobject,
